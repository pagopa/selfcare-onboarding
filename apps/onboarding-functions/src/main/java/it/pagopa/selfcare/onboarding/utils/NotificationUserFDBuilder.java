...
public interface NotificationUserFDBuilder {
    NotificationToSend buildUserNotificationToSend(Onboarding onboarding, Token token, InstitutionResponse institution, QueueEvent queueEvent);

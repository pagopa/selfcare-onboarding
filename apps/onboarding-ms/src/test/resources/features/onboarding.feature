...
Feature: Onboarding collection
  ...
  Scenario: Can't perform onboarding request for an invalid object
    ...
    When I send a POST request to "/pa" with the request named "invalid_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding request with missing origin and originId
    ...
    When I send a POST request to "/pa" with the request named "empty_origin_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding request with missing users node
    ...
    When I send a POST request to "/pa" with the request named "empty_users_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding request with missing digitalAddress attribute
    ...
    When I send a POST request to "/pa" with the request named "empty_pec_request"
    Then the response status code should be 400
  ...
  Scenario: Successfully store onboarding in status REQUEST
    ...
    When I send a POST request to "/pa" with the request named "success_pa_request"
  ...
  Scenario: Can't perform onboarding with parent not completed
    ...
    When I send a POST request to "/pa" with the request named "invalid_child_product_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding for the same product, taxCode and workflowType
    ...
    When I send a POST request to "/pa" with the request named "duplicated_onboarding_request"
  ...
  Scenario: Can't perform onboarding for prod-io-premium with not allowed pricingPlan
    ...
    When I send a POST request to "/pa" with the request named "invalid_io_premium_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding for GSP without additional information
    ...
    When I send a POST request to "/pa" with the request named "invalid_gsp_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding for GSP without note field
    ...
    When I send a POST request to "/pa" with the request named "invalid_gsp_note_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding request for invalid digitalAddress (different from IPA registry one)
    ...
    When I send a POST request to "/pa" with the request named "invalid_proxy_pec_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding request for invalid recipient code (different from IPA registry one)
    ...
    When I send a POST request to "/pa" with the request named "invalid_proxy_recipient_code_request"
  ...
  Scenario: Successfully perform onboarding request for AOO
    ...
    When I send a POST request to "/pa" with the request named "success_aoo_request"
    Then the response status code should be 200
    And the response body should not be empty
    And the response should have field "status" with value "REQUEST"
  ...
  Scenario: Successfully perform onboarding request for UO
    ...
    When I send a POST request to "/pa" with the request named "success_uo_request"
    Then the response status code should be 200
    And the response body should not be empty
    And the response should have field "status" with value "REQUEST"
  ...
  Scenario: Can't perform onboarding request for UO with invalid recipientCode
    ...
    When I send a POST request to "/pa" with the request named "invalid_recipient_code_uo_request"
    Then the response status code should be 400
  ...
  Scenario: Can't perform onboarding request for UO with denied billing
    ...
    When I send a POST request to "/pa" with the request named "invalid_billing_uo_request"
    Then the response status code should be 400
